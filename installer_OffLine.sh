...
if [[ "$check_amrif" == "$firma2" ]]; then  
    ...
    info "${YELLOW}Changing to use FIRST STREAM= AAC 5.1 480kbps (or AC3 5.1 576kbps), SECOND STREAM= MP3 2.0 224kbps in VIDEO-STATION." >> $logfile
    
    # Modifier les configurations pour AAC en 5.1 avec un tampon plus grand et une qualité légèrement réduite
    ...
    sed -i 's/args2vs+=("-b:a:0" "256k" "-b:a:1" "512k")/args2vs+=("-b:a:0" "480k" "-b:a:1" "224k" "-max_delay" "40000000" "-bufsize" "16000000")/gi' ${cp_bin_path}/ffmpeg41 2>> $logfile

    # Modifier les configurations pour AC3 en 5.1 avec un tampon plus grand et une qualité légèrement réduite
    ...
    sed -i 's/args2vs+=("-b:a:0" "256k" "-b:a:1" "640k")/args2vs+=("-b:a:0" "576k" "-b:a:1" "224k" "-max_delay" "40000000" "-bufsize" "16000000")/gi' ${cp_bin_path}/ffmpeg41 2>> $logfile
